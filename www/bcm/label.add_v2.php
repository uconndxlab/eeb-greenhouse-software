...
$sql = 'insert into labels_v2 (codeno,latin_name,commonname,cntry_orig,habitat,feature,family,source) values ('.$codeno.',"'.$latin_name.'","'.$commonname.'","'.$cntry_orig.'","'.$habitat.'","'.$feature.'","'.$family.'","'.$source.'")';
$sth = $db->prepare($sql);
$sth->execute();

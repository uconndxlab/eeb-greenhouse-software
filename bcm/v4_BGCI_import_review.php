...
foreach($db->query($sql) as $row) {
	...
	echo '<a name="'.$latin_name.'">'.$latin_name.' - ';
...
#	$i2=0;
#	while ($i2<$num2) {
#		$codeno = mysql_result($sql_result2,$i2,"codeno");
#		echo $codeno.' - ';
#		echo '<a href="/bcm/accession.php?codeno='.mysql_result($sql_result2,$i2,"codeno").'" target="_blank">';
#		echo mysql_result($sql_result2,$i2,"latin_name");
#		echo '</a> - ';
#		if (mysql_result($sql_result2,$i2,"bgci_status")<>$namestatus) {
 #                      echo '[<font color="RED">**<a href="/bcm/editdropdown.php?codeno='.$codeno.'&v=bgci_status';
  #                     echo '&url=http://florawww.eeb.uconn.edu/bcm/BGCI_import_review.php%23'.$latin_name.'">';    
   #                    echo '**'.mysql_result($sql_result2,$i2,"bgci_status").'</a></font>]';
	#		} else {
	#		echo $namestatus;
	#	} # if bgcistatus
	#	echo ' ';
  #         if (mysql_result($sql_result2,$i2,"bgci_exsitusites")<>$bgcisites) {
#                        echo '[<font color="RED">**<a href="/bcm/edittext.php?codeno='.$codeno.'&v=bgci_exsitusites';
#			echo '&url=http://florawww.eeb.uconn.edu/bcm/BGCI_import_review.php%23'.$latin_name.'">';
#			echo '**'.mysql_result($sql_result2,$i2,"bgci_exsitusites").'</a></font>]';
#                       } else {
#                        echo $bgcisites;
#              } # if bgcisites
#		echo ' {';
